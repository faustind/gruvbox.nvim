...
M.setup = function()
  ...
  local groups = {
    ...
    DiffDelete = { bg = colors.red, reverse = config.inverse_diff },
    DiffAdd = { bg = colors.green, reverse = config.inverse_diff },
    DiffChange = { bg = colors.aqua, reverse = config.inverse_diff },
    DiffText = { bg = colors.yellow, reverse = config.inverse_diff },
